    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        consumer.ReceivedAsync += async (model, ea) =>
        {
            try
            {
                ...
                _logger.LogInformation($"Received LMP event. SerialNumber={message.SerialNumber}, EventType={message.EventType}, TimeStamp={message.TimeStamp}");
            ...
            {
                _logger.LogError(ex, "Error while processing LMP message");
        ...
        _logger.LogInformation($"LMP worker started. Queue={queueName}, RoutingKey={routingKey}");
