    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        consumer.ReceivedAsync += async (model, ea) =>
        {
            try
            {
                ...
                _logger.LogInformation($"Received VKP event. SerialNumber={message.SerialNumber}, EventType={message.EventType}, TimeStamp={message.TimeStamp}");
            ...
            {
                _logger.LogError(ex, "Error while processing VKP message");
        ...
        _logger.LogInformation($"VKP worker started. Queue={queueName}, RoutingKey={routingKey}");
